...
$('.earn-points-4').click(function() {
  earnPoints(4);
});

$('.earn-points-10').click(function() {
  earnPoints(10);
});

$('.earn-points-20').click(function() {
  earnPoints(20);
});
...
$('.use-points-10').click(function() {
  usePoints(10);
});

$('.use-points-15').click(function() {
  usePoints(15);
});

$('.use-points-20').click(function() {
  usePoints(20);
});
